...
<div class="con flex" style="margin-top:30px">
...
<div class="article-list-box-1 con">
			...
			<tbody>
				<c:forEach items="${articles}" var="article">
					<tr>
						...
						<td class="text-align-center"	>${article.hit}</td>
	...
	<div class="con page-box" style="margin-top: 30px">
...
<div class="con">
	<div class="flex-grow-1 flex-jc-c flex-ai-c flex-as-c" style="padding: 0 30px">총 게시물 수 : ${totalCount}</div>
</div>
